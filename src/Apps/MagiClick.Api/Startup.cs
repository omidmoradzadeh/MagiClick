...
using MagiClick.Application;
using MagiClick.Application.Common.Interfaces;
using MagiClick.Api.Filters;
using MagiClick.Api.Services;
using FluentValidation.AspNetCore;
using MagiClick.Infrastructure;
...
namespace MagiClick.Api
{
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MagiClick API"));
