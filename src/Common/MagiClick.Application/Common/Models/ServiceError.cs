...
namespace MagiClick.Application.Common.Models
{
    /// <summary>
    ...
    public class ServiceError
    {
        ...
        public static ServiceError PersonAlreadyExist => new ServiceError("Person is already exist.", 897);

        public static ServiceError PersonNotExist => new ServiceError("Person is not exist.", 896);

        public static ServiceError NotificationTypeIdNotExist => new ServiceError("Notification Type Id is not exist.", 895);
